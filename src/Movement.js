    ...
    return (
        ...
        >
            <div className={classes.paper}>
                ...
                <input placeholder={props.movement.from} value={inpu2} onChange={event => setInpu2(event.target.value)}/>
                <input placeholder={props.movement.to} value={inpu3} onChange={event => setInpu3(event.target.value)}/>
                <input placeholder={props.movement.quantity} value={inpu4} onChange={event => setInpu4(event.target.value)}/>
